...
/**
 * monty - main function helper function
 * @args: pointer to structure of args from main
 *
 * Description: opens and reads the file with opcodes and
 * calls the function which finds the executing function
 */
